...
import { ConfigService } from '../../../apps/core/services/config.service';
import { LayoutService } from '../../../apps/core/services/layout.service';
...
export class SidebarComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    if (this.config.layout.sidebar.backgroundColor === 'white') {
      ...
      let xx: any[];
      xx = raja;
      xx.push({ path: '/kendo-table', title: 'KendoTable', icon: 'ft-message-square', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] });
