...
export class UmLevel1EditComponent implements OnInit {
    ...
    public editForm: FormGroup = new FormGroup({
        ...
        id_master_unit: new FormControl(),
        nama_unit_lv1: new FormControl('', Validators.required)
    });
    ...
    public onSave(e) {
        ...
        if(this.isNew) {
            delete data_insert['id_unit_level1'];
            ...
            let id_update = {"id_unit_level1":data_insert.id_unit_level1};
