...
export class UmLevel2EditComponent implements OnInit {
    ...
    public editForm: FormGroup = new FormGroup({
        id_unit_level1: new FormControl(),
        id_unit_level2: new FormControl(),
        nama_unit_lv2: new FormControl('', Validators.required)
    });
    ...
    @Input() public set model(dataEdit: ModUnitMasterLevel) {
        ...
        if(this.isNew) {
            ...
            this.selectedValue = dataEdit.id_unit_level1;
    ...
    public selectedValue = this.editForm.value['id_unit_level1'];
    ...
    public getListLevel() {
        this.http.get(`${this.urledit}/data_unit_level1`,{},"Data Level 1").subscribe( data => {
    ...
    public onSave(e) {
        ...
        if(this.isNew) {
            delete data_insert['id_unit_level2'];
            ...
            let id_update = {"id_unit_level2":data_insert.id_unit_level2};
