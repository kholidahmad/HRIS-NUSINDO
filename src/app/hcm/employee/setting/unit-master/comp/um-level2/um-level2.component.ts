...
export class UmLevel2Component implements OnInit {
    ...
    ngOnInit() {
        ...
        this.url = "/api/f_employee/f_setting/f_unit_master/c_unit_master_lv2/"+this.parameterUrl;
