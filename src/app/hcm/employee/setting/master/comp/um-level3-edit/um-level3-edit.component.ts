...
export class UmLevel3EditComponent implements OnInit {
    ...
    public editForm: FormGroup = new FormGroup({
        ...
        id_level3: new FormControl(),
        nama_lv3: new FormControl('', Validators.required)
    });
    ...
    @Input() public set model(dataEdit: ModMasterLevel) {
        ...
        if(this.isNew) {
            ...
            this.selectedValue = dataEdit.id_level2;
    ...
    public getListLevel() {
        this.http.get(`${this.urledit}/data_level2`,{},"Data Level 2").subscribe( data => {
    ...
    public onSave(e) {
        ...
        if(this.isNew) {
            ...
            let id_update = {"id_level3":data_insert.id_level3};
