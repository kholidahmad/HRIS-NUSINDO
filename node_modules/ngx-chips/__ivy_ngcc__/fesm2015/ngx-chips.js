...
function TagComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵattribute("contenteditable", ctx_r833.editing);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(3, _c1, ctx_r833.model, ctx_r833.index))("ngTemplateOutlet", ctx_r833.template);
} }
function TagComponent_div_2_delete_icon_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function TagComponent_div_2_delete_icon_3_Template_delete_icon_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r839); const ctx_r838 = ɵngcc0.ɵɵnextContext(2); return ctx_r838.remove($event); });
    ɵngcc0.ɵɵelementEnd();
} }
function TagComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown.enter", function TagComponent_div_2_Template_div_keydown_enter_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r841); const ctx_r840 = ɵngcc0.ɵɵnextContext(); return ctx_r840.disableEditMode($event); })("keydown.escape", function TagComponent_div_2_Template_div_keydown_escape_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r841); const ctx_r842 = ɵngcc0.ɵɵnextContext(); return ctx_r842.disableEditMode($event); })("click", function TagComponent_div_2_Template_div_click_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r841); const ctx_r843 = ɵngcc0.ɵɵnextContext(); return ctx_r843.editing ? $event.stopPropagation() : undefined; })("blur", function TagComponent_div_2_Template_div_blur_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r841); const ctx_r844 = ɵngcc0.ɵɵnextContext(); return ctx_r844.onBlurred($event); });
    ɵngcc0.ɵɵtext(2);
    ɵngcc0.ɵɵelementEnd();
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵattribute("contenteditable", ctx_r834.editing)("title", ctx_r834.getDisplayValue(ctx_r834.model));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r834.getDisplayValue(ctx_r834.model), " ");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r834.isDeleteIconVisible());
} }
function TagComponent_tag_ripple_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("state", ctx_r835.rippleState);
...
function TagInputDropdown_ng2_menu_item_2_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r846 = ɵngcc0.ɵɵnextContext().$implicit;
    const ctx_r849 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("innerHTML", ɵngcc0.ɵɵpipeBind2(1, 1, item_r846[ctx_r849.displayBy], ctx_r849.tagInput.inputForm.value.value), ɵngcc0.ɵɵsanitizeHtml);
} }
...
function TagInputDropdown_ng2_menu_item_2_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r846 = ctx_r853.$implicit;
    const index_r847 = ctx_r853.index;
    const last_r848 = ctx_r853.last;
    const ctx_r850 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r850.templates.first)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction3(2, _c2, item_r846, index_r847, last_r848));
} }
function TagInputDropdown_ng2_menu_item_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r846 = ctx.$implicit;
    const ctx_r845 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("value", item_r846)("ngSwitch", !!ctx_r845.templates.length);
    ɵngcc0.ɵɵadvance(1);
...
function TagInputComponent_tag_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onSelect", function TagInputComponent_tag_2_Template_tag_onSelect_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r860); const item_r857 = ctx.$implicit; const ctx_r859 = ɵngcc0.ɵɵnextContext(); return ctx_r859.selectItem(item_r857); })("onRemove", function TagInputComponent_tag_2_Template_tag_onRemove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r860); const item_r857 = ctx.$implicit; const i_r858 = ctx.index; const ctx_r861 = ɵngcc0.ɵɵnextContext(); return ctx_r861.onRemoveRequested(item_r857, i_r858); })("onKeyDown", function TagInputComponent_tag_2_Template_tag_onKeyDown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r860); const ctx_r862 = ɵngcc0.ɵɵnextContext(); return ctx_r862.handleKeydown($event); })("onTagEdited", function TagInputComponent_tag_2_Template_tag_onTagEdited_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r860); const ctx_r863 = ɵngcc0.ɵɵnextContext(); return ctx_r863.updateEditedTag($event); })("onBlur", function TagInputComponent_tag_2_Template_tag_onBlur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r860); const i_r858 = ctx.index; const ctx_r864 = ɵngcc0.ɵɵnextContext(); return ctx_r864.onTagBlurred($event, i_r858); })("dragstart", function TagInputComponent_tag_2_Template_tag_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r860); const item_r857 = ctx.$implicit; const i_r858 = ctx.index; const ctx_r865 = ɵngcc0.ɵɵnextContext(); return ctx_r865.dragZone ? ctx_r865.onDragStarted($event, item_r857, i_r858) : undefined; })("drop", function TagInputComponent_tag_2_Template_tag_drop_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r860); const i_r858 = ctx.index; const ctx_r866 = ɵngcc0.ɵɵnextContext(); return ctx_r866.dragZone ? ctx_r866.onTagDropped($event, i_r858) : undefined; })("dragenter", function TagInputComponent_tag_2_Template_tag_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r860); const ctx_r867 = ɵngcc0.ɵɵnextContext(); return ctx_r867.dragZone ? ctx_r867.onDragOver($event) : undefined; })("dragover", function TagInputComponent_tag_2_Template_tag_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r860); const i_r858 = ctx.index; const ctx_r868 = ɵngcc0.ɵɵnextContext(); return ctx_r868.dragZone ? ctx_r868.onDragOver($event, i_r858) : undefined; })("dragleave", function TagInputComponent_tag_2_Template_tag_dragleave_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r860); const ctx_r869 = ɵngcc0.ɵɵnextContext(); return ctx_r869.dragZone ? ctx_r869.dragProvider.onDragEnd() : undefined; });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const item_r857 = ctx.$implicit;
    const i_r858 = ctx.index;
    const ctx_r854 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵpropertyInterpolate("draggable", ctx_r854.editable);
    ɵngcc0.ɵɵproperty("canAddTag", ctx_r854.isTagValid)("disabled", ctx_r854.disable)("@animation", ctx_r854.animationMetadata)("hasRipple", ctx_r854.ripple)("index", i_r858)("removable", ctx_r854.removable)("editable", ctx_r854.editable)("displayBy", ctx_r854.displayBy)("identifyBy", ctx_r854.identifyBy)("template", !!ctx_r854.hasCustomTemplate() ? ctx_r854.templates.first : undefined)("draggable", ctx_r854.dragZone)("model", item_r857);
...
function TagInputComponent_div_6_p_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const error_r871 = ctx.$implicit;
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(error_r871);
} }
function TagInputComponent_div_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r856.theme);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r856.errors);
} }
const _c3 = ["*"];
