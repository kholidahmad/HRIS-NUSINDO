...
export declare class PanelBarItemComponent implements AfterContentChecked, AfterViewChecked, OnDestroy {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<PanelBarItemComponent>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<PanelBarItemComponent, "kendo-panelbar-item", ["kendoPanelbarItem"], {
    "title": "title";
    "id": "id";
    "icon": "icon";
    "iconClass": "iconClass";
    ...
    "items": "items";
    "template": "template";
}, {}, ["contentItems", "contentTemplate", "titleTemplates"]>;
}
