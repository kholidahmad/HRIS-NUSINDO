...
*-------------------------------------------------------------------------------------------*/
import { OnDestroy, Renderer2, ElementRef, EventEmitter, NgZone, OnInit } from "@angular/core";
...
export declare class FileSelectComponent implements OnInit, OnDestroy {
    ...
    private subs;
    constructor(uploadService: UploadService, localization: LocalizationService, navigation: NavigationService, ngZone: NgZone, renderer: Renderer2, wrapper: ElementRef);
    ngOnInit(): void;
    /**
     * @hidden
     */
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<FileSelectComponent>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<FileSelectComponent, "kendo-fileselect", ["kendoFileSelect"], {
    "disabled": "disabled";
    "multiple": "multiple";
