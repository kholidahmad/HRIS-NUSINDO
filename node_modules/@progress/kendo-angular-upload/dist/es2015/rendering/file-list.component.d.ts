...
export declare class FileListComponent implements OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<FileListComponent>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<FileListComponent, "[kendo-upload-file-list]", never, {
    "disabled": "disabled";
    "fileList": "fileList";
...
//# sourceMappingURL=file-list.component.d.ts.map